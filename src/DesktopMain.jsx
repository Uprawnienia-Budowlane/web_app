        ...
        return (
            <div className="h-full w-full rounded-3xl bg-white flex flex-row justify-between flex-wrap">
                ...
                <div className="my-6 mr-8 shadow-md rounded-3xl bg-blue-500 flex-col">
                    <div className="flex-col mx-2 my-8">
                        <p className="text-white">Podgląd</p>
                        <h1 className="font-bold text-white text-2xl">Twoich Statystyk</h1>

                        <div className="mt-8 rounded-3xl bg-white flex-col">
                            <div className="mx-4 mt-6 flex-row">
                                <button
                                    className="mt-2 rounded-2xl border border-blue-500 text-blue-500 font-medium text-center text-lg py-3 px-4 w-72">Nauka
                                </button>
                                <button
                                    className="mt-2 rounded-2xl bg-blue-500 border border-blue-500 text-white font-medium text-center text-lg py-3 px-4 w-72">Egzamin
                                </button>
                            </div>
