...
const AddAnotherWebiste = ({ push, route }) => {
...
<div className="add_something_panel_itself_first" style={{ height: '186px' }}>
...
export default AddAnotherWebiste